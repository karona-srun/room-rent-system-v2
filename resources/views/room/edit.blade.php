                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="d-flex flex-row justify-content-between">
                                <div class="pd-1">
                                    <div class="az-content-label mg-b-5">{{ __('app.label_edit_room') }}</div>
                            ...
                            <form action="{{ url('room', $room->id) }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        <label class="form-label">{{ __('app.label_price') }} <span
                                                class="tx-danger">*</span></label>
                                        <input class="form-control" name="price" step="any"
                                    ...
                                    <div class="col-sm-3 mb-2">
                                        ...
                                        <select class="form-control select2-no-search" name="status">
                                            <option value="Free" {{ $room->status == 'Free' ? 'selected' : '' }}>
                                                {{ __('app.status_free') }}</option>
                                            <option value="Rented" {{ $room->status == 'Rented' ? 'selected' : '' }}>
                                                {{ __('app.status_rented') }}</option>
                                            <option value="Fixing" {{ $room->status == 'Fixing' ? 'selected' : '' }}>
                                                {{ __('app.status_fixing') }}</option>
                                        </select>
                                        @error('status')
                                            <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                                <li class="parsley-required">{{ $message }}</li>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12 mb-2">
                                        ...
                                        <textarea class="form-control" rows="3" name="noted">{{ $room->noted }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
