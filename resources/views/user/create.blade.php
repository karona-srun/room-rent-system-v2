                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                ...
                                                <input class="form-control" name="email" value=""
                                                    placeholder="{{ __('app.label_user_email') }}" value="{{old('email')}}" type="email">
                                                @error('email')
                                                    <ul class="parsley-errors-list filled" id="parsley-id-5"
                                                        aria-hidden="false">
                                                        <li class="parsley-required">{{ $message }}</li>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-4 mb-2">
                                                ...
                                                <select class="form-control select2-no-search" name="is_active">
                                                    <option value="1">{{ __('app.label_user_active') }}</option>
                                                    <option value="0">{{ __('app.label_user_inactive') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
